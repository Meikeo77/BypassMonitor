...
@implementation NSString (BMExtensionDeprecated_v_2_5_16)
- (NSString *)underlineFromCamel
{
    return self.bm_underlineFromCamel;
}

- (NSString *)camelFromUnderline
{
    return self.bm_camelFromUnderline;
}

- (NSString *)firstCharLower
{
    return self.bm_firstCharLower;
}

- (NSString *)firstCharUpper
{
    return self.bm_firstCharUpper;
}

- (BOOL)isPureInt
{
    return self.bm_isPureInt;
}
